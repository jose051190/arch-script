...
if [ "$desktop_choice" == "1" ]; then
  ...
  sudo pacman -S --needed gnome gnome-tweaks xorg-xwayland wl-clipboard fwupd ffmpeg ffmpegthumbnailer nextcloud-client ttf-nerd-fonts-symbols inter-font ttf-jetbrains-mono plymouth xdg-desktop-portal-gnome neovim firefox-i18n-pt-br ttf-fira-sans ttf-roboto-mono-nerd ttf-fira-mono rclone telegram-desktop fastfetch htop ncdu virt-manager qemu-full ebtables iptables-nft dnsmasq edk2-ovmf spice-vdagent pycharm-community-edition firewalld chromium
